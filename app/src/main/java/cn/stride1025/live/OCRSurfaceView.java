...
public class OCRSurfaceView extends android.view.SurfaceView implements  SurfaceHolder.Callback ,Runnable{
    ...
    public OCRSurfaceView(Context context, AttributeSet attrs) {
        ...
        mHolder.addCallback(this);//接口指向实现类，回调，保证surfaceCreated()等方法运行
